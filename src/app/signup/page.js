...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-500 to-pink-500 px-4">
<div className="bg-white/90 backdrop-blur-md p-8 rounded-xl shadow-xl w-4/6 max-w-4xl mx-auto flex flex-col md:flex-row items-center overflow-hidden">
        ...
        <div className="hidden md:block w-1/2 pl-6 relative">
